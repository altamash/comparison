...
public class App_ {
    ...
    public static volatile SingularAttribute<App, String> host;
    public static volatile SingularAttribute<App, Boolean> isActive;


    public static volatile SetAttribute<App, User> userAppViaAppSourceKey;

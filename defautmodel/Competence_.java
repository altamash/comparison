...
public class Competence_ {
    ...
    public static volatile SetAttribute<Competence, Script> scriptViaScriptCompetenceByScriptId;
    public static volatile SetAttribute<Competence, User> userViaUserCompetenceByUserId;
